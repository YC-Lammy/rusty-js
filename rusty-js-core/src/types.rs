...
impl JValue{
    ...
    */
    ...
    pub fn is_object(&self) -> bool{
        return self.type_pointer as *const _ == &OBJECT_TYPE_POINTER
    }
    ...
    pub unsafe fn call_(self, runtime:&Runtime, this:JValue, argv:*const TempAllocValue, argc:u32, stack:*mut JValue) -> (JValue, bool){
        let mut len = 0;
    ...
    pub unsafe fn call_raw(self, runtime:&Runtime, this:JValue, stack:*mut JValue, argc:u32)  -> (JValue, bool){
        if self.is_object(){
    ...
    pub fn call(self, ctx:JSFuncContext, this:JValue, args:&[JValue]) -> Result<JValue, JValue>{
        if !self.is_object(){
            return Err(JValue::Error(Error::TypeError("cannot call on non function".to_owned())))
        }
    ...
    pub unsafe fn new_raw(self, runtime:&Runtime, stack:*mut JValue, argc:u32) -> (JValue, bool){
        todo!()
    }
    ...
    pub(crate) fn set_property_raw(self, field_id:u32, value:JValue, stack:*mut JValue) -> (JValue, bool){
...
impl PartialEq for JValue{
    fn eq(&self, other: &Self) -> bool {
        unsafe{std::mem::transmute_copy::<_, [usize;2]>(self) == std::mem::transmute_copy::<_,[usize;2]>(other)}
    }
}
...
mod number{
    ...
    pub(crate) unsafe fn add(value:JValueUnion, rhs:JValue) -> (JValue, bool){
        let v = if rhs.is_number(){
            ...
            JValue::String((value.number.to_string() + rhs.value.object.to_string().as_str()).into())
...
mod string{
    ...
    pub (crate) unsafe fn set(obj:JValueUnion, field:JValue, value:JValue, stack:*mut JValue) -> (JValue, bool){
        (value, false)
    }

    pub(crate) unsafe fn set_static(obj:JValueUnion, field:u32, value:JValue, stack:*mut JValue) -> (JValue, bool){
        (value, false)
    }
    ...
    pub(crate) unsafe fn get(obj:JValueUnion, field:JValue, stack:*mut JValue) -> (JValue, bool){
    ...
    pub(crate) unsafe fn get_static(obj:JValueUnion, field:u32, stack:*mut JValue) -> (JValue, bool){
...
mod bigint{
    ...
    pub(crate) unsafe fn add(value:JValueUnion, rhs:JValue) -> (JValue, bool){
        let v = if rhs.is_bigint(){
            ...
            return (JValue::Error(Error::TypeError("TypeError: Cannot mix BigInt and other types, use explicit conversions".into())), true)
        };
        (v, false)
    }
    ...
    pub(crate) unsafe fn sub(value:JValueUnion, rhs:JValue) -> (JValue, bool){
        if rhs.is_bigint(){
            ...
            (JValue::Error(Error::TypeError("TypeError: Cannot mix BigInt and other types, use explicit conversions".to_owned())), true)
        }
    }
    ...
    pub(crate) unsafe fn exp(value:JValueUnion, rhs:JValue) -> (JValue, bool){
        if rhs.is_bigint(){
            (JValue::BigInt(value.bigint.pow(rhs.value.bigint as u32) ), false)
        } else{
            (JValue::Error(Error::TypeError("TypeError: Cannot mix BigInt and other types, use explicit conversions".to_owned())), true)
        }
    }
...
mod object{
    ...
    pub(crate) unsafe fn add(value:JValueUnion, rhs:JValue) -> (JValue, bool){
        if value.object.is_primitive(){
            ...
            ((value.object.to_string() + rhs.to_string().as_str()).into(), false)
        }
    }
    ...
    pub(crate) unsafe fn set(obj:JValueUnion, field:JValue, value:JValue, stack:*mut JValue) -> (JValue, bool){
        obj.object.inner.to_mut().set_property(&field.to_string(), value, stack)
    }
    ...
    pub(crate) unsafe fn instanceOf(value:JValueUnion, rhs:JValue) -> (JValue, bool){
        let v:bool = if rhs.is_object(){
            if rhs.value.object.inner.wrapped_value.is_function(){
                let v = rhs.value.object.get_property("prototype", std::ptr::null_mut()).unwrap();
                value.object.get_property("__proto__", std::ptr::null_mut()).unwrap() == v
            } else{
                false
            }
        } else{
...
mod notObject{
    ...
    pub(crate) fn get(value:JValueUnion, rhs:JValue, stack:*mut JValue) -> (JValue, bool){
        (JValue::Error(Error::TypeError("cannot read property of non object".into())), true)
    }
    ...
    pub(crate) fn set(obj:JValueUnion, field:JValue, value:JValue, stack:*mut JValue) -> (JValue, bool){
        (JValue::Error(Error::TypeError("cannot set property of non object".into())), true)
    }

    pub(crate) fn set_static(obj:JValueUnion, field:u32, value:JValue, stack:*mut JValue) -> (JValue, bool){
        (JValue::Error(Error::TypeError("cannot set property of non object".into())), true)
    }
    ...
    pub(crate) unsafe fn instanceOf(value:JValueUnion, rhs:JValue) -> (JValue, bool){
        if !rhs.is_object(){
            return (JValue::Error(Error::TypeError("Right-hand side of 'instanceof' is not callable".into())), true)
        }
        (JValue::FALSE, false)
    }
