use crate::runtime::{FuncID, ClassID, ConstID, RegexID, StringID};
...
impl CompactRegister{
    pub fn target(&self) -> Register{
        match self{
            ...
            Self::T0R1 |
            Self::T0R2 |
            Self::T0R3 => Register(0),
            Self::T1R0 |
            Self::T1R1 |
            Self::T1R2 |
            Self::T1R3 => Register(1),
            Self::T2R0 |
            Self::T2R1 |
            Self::T2R2 |
            Self::T2R3 => Register(2),
            Self::T3R0 |
            Self::T3R1 |
            Self::T3R2 |
            Self::T3R3 => Register(3)
        }
    }
    ...
    pub fn value(&self) -> Register{
        match self{
            ...
            Self::T1R0 |
            Self::T2R0 |
            Self::T3R0 => Register(0),
            Self::T0R1 |
            Self::T1R1 |
            Self::T2R1 |
            Self::T3R1 => Register(1),
            Self::T0R2 |
            Self::T1R2 |
            Self::T2R2 |
            Self::T3R2 => Register(2),
            Self::T0R3 |
            Self::T1R3 |
            Self::T2R3 |
            Self::T3R3 => Register(3)
