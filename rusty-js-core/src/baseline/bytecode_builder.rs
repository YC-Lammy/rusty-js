        ...
        match stmt {
            ...
            Stmt::For(f) => {
                ...
                if let Some(e) = &f.test {
                    ...
                    self.bytecode.push(OpCode::BreakIfFalse { value: test, exit:exit });
                    self.bytecode.push(OpCode::JumpIfFalse {
                        value: test,
                        to: exit,
                    });
            ...
            Stmt::ForIn(f) => {
                ...
                self.bytecode.push(OpCode::BreakIfIterDone{ exit: exit});
                ...
                self.bytecode.push(OpCode::Jump { to: header, line: 0 });
            ...
            Stmt::If(i) => {
                ...
                // else block
                self.bytecode.push(OpCode::SwitchToBlock(alt));
            ...
            Stmt::While(w) => {
                ...
                self.bytecode.push(OpCode::BreakIfFalse { value: v, exit: exit });
                self.bytecode
                    .push(OpCode::JumpIfFalse { value: v, to: exit });
    ...
    fn translate_expr(&mut self, expr: &Expr) -> Result<Register, Error> {
        match expr {
            Expr::Array(a) => {
                ...
                self.bytecode.push(OpCode::CreateArray { result: self.r1 });
                ...
                Lit::BigInt(b) => {
                    if b.value.bits() <= 32 {
                        ...
                        let id = self
                            .runtime
                            .to_mut()
                            .unamed_constant(JValue::BigInt(b.value.to_i64().unwrap()));
                ...
                Lit::Num(n) => {
                    if n.value > f32::MAX as f64 {
                        let id = self
                            .runtime
                            .to_mut()
                            .unamed_constant(JValue::Number(n.value));
            ...
            Expr::TaggedTpl(t) => {
                ...
                self.bytecode.push(OpCode::CreateTaggedTemplate {
                    result: self.r1,
                    id,
                    stack_offset:self.ctx.current_stack_offset()
                });
            ...
            Expr::Update(u) => {
                ...
                match u.arg.as_ref() {
                    ...
                    Expr::Ident(i) => self.bytecode.push(self.ctx.set(i.to_id(), self.r1)),
                    _ => todo!(),
                }
            }
            Expr::Yield(y) => {
