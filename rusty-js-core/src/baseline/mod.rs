...
pub struct Function{
    profiler:Profiler,
    /// fn(...) -> (result, is_error)
    func:fn(this:JValue, ctx:&Runtime, stack:*mut JValue, argc:u32, capture_stack:*mut JValue) -> (JValue, bool),
    code_size:usize,
}

impl Function{
    pub fn call(&self, runtime:&Runtime, this:JValue, argc:u32, stack:*mut JValue, capture_stack:*mut JValue) -> (JValue, bool){
